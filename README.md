...
~~~sh
# getting the code
git clone git@github.com:nko4/frontend-bahia.git && cd ./frontend-bahia/

# developing
npm install
npm start

# deploying (to http://frontend-bahia.2013.nodeknockout.com/)
./deploy nko

# ssh access
ssh deploy@frontend-bahia.2013.nodeknockout.com
ssh root@frontend-bahia.2013.nodeknockout.com
# or, if you get prompted for a password
ssh -i ./id_deploy deploy@frontend-bahia.2013.nodeknockout.com
ssh -i ./id_deploy root@frontend-bahia.2013.nodeknockout.com
~~~
...
~~~html
<iframe src="http://nodeknockout.com/iframe/frontend-bahia" frameborder=0 scrolling=no allowtransparency=true width=115 height=25>
</iframe>
~~~
